...
A GitHub Action to track code coverage in your pull requests, ported to Go from the original [gha-common/go-beautiful-html-coverage](https://github.com/gha-common/go-beautiful-html-coverage/) by original author [@kilianc](https://github.com/kilianc) who made [a beautiful HTML preview ↗](https://kilianc.github.io/pretender/head/head.html#file0), for free.
...
Note: If you like this project, buy [@kilianc](https://github.com/kilianc) a coffee above. I'm already too caffienated!
...
1. Create and push [new orphan branch](https://github.com/StevenACoffman/go-beautiful-html-coverage/tree/cover) if one doesn't exist.
